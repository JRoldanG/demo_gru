      ...
      <div className="container" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "var(--space-xl)" }}>
        ...
        <div>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: "0.95rem", lineHeight: 1.6 }}>
            Más de 30 años de excelencia e investigación farmacéutica en Colombia. Mejorando la calidad de vida a través de la innovación científica.
          </p>
        </div>
  ...
  return (
    <html lang="es">
      <head>
        ...
        <meta name="description" content="Gruinfacol S.A. es una empresa colombiana dedicada a la investigación farmacéutica con más de 30 años de experiencia." />
      </head>
      <body>
        <CartProvider>
          <Navbar />
